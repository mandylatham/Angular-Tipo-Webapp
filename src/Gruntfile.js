    ...
    copy: {
      dist: {
        files:[
          ...
          {
            expand: true,
            cwd: '<%= config.directories.source %>/_scripts/non-bower-managed',
            src: ['**'],
            dest: '<%= config.directories.dist %>/_scripts/non-bower-managed'
          },
          {
            expand: true,
    ...
    'string-replace': {
      google: {
        files: {
          ...
          'g/public/public/common/views/custom/registration.tpl.html': 'g/public/public/common/views/custom/registration.tpl.html',
        },
        options: {
          replacements: [
            {
