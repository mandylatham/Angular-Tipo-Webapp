...
ClusterIcon.prototype.show = function() {
    if (this.div_) {
        ...
        img = "<md-icon class='material-icons " + this.customStyle_ + "'  style='position: absolute;font-size:" + this.iconSize_ + "px; top: " + spriteV + "px; left: " + spriteH + "px; ";
        if (this.cluster_.getMarkerClusterer().enableRetinaIcons_) {
            img += "width: " + this.width_ + "px; height: " + this.height_ + "px;";
        } else {
            // img += "clip: rect(" + ((-1 * spriteV) - 7) + "px, " + ((-1 * spriteH) + this.width_) + "px, " +
            //     ((-1 * spriteV) + this.height_) + "px, " + (-1 * spriteH) + "px);";
        }
        img += "'>" + this.url_ + "</md-icon>";
        this.div_.innerHTML = img + "<div style='" +
            "position: absolute;" + this.labelStyle_ +
            ...
            // "width: " + 18 + "px;" +
            // "line-height:" + 18 + "px;" +
            "' class='" + this.labelCss_ + "'>" + this.sums_.text + "</div>";
...
ClusterIcon.prototype.useStyle = function(sums) {
    ...
    this.customStyle_ = style.customStyle || "";
    this.iconSize_ = style.iconSize || 48;
    this.labelStyle_ = style.labelStyle || "";
    this.labelCss_ = style.labelCss || "";
