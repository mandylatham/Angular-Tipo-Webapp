            ...
            request: function(config) {
                ...
                if ($rootScope.version_stamp) {
                    ...
                    if (_.startsWith(config.url, "g/") && $rootScope.cdn_host && !$templateCache.get(config.url + "?version_stamp=" + config.params.version_stamp)) {
                        ...
                        if (_.endsWith(config.url, "___TipoApp") || _.endsWith(config.url, "___TipoDefinition") || (_.startsWith($stateParams.perspective, "TipoApp.") && !(config.headers['X-bypass-cdn'] === "true"))) {
