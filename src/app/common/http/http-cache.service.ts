...
export class HttpCacheService {
   ...
   *  lastUpdated The cache last update, current date is used if not specified.
   */
   ...
   * expirationDate The cache expiration date. If no date is specified, all cache is cleared.
   */
   ...
   *  persistence How the cache should be persisted, it can be either local or session
