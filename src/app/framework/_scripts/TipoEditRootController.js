(function() {
    ...
    function TipoEditRootController(
        ...
        _instance.showDetail = function(htmltemplate, fq_field_name, field_name) {
            ...
            var promise = $mdDialog.show({
                template: '<md-dialog id="dialog' + _instance.popupno + '" ng-cloak ng-class="{\'fullscreen\': fullscreen}"><md-toolbar class="tipo-toolbar"><div class="md-toolbar-tools"><h2>{{definition.display_name}}</h2><span flex></span><md-button style="line-height: 1.2;font-weight: bold;" ng-click="maximize()" ng-if="!fullscreen"> <md-icon aria-label="Maximize">flip_to_back</md-icon><div>Resize</div></md-button><md-button style="line-height: 1.2;font-weight: bold;" ng-click="restore()" ng-if="fullscreen"><md-icon aria-label="Restore size">flip_to_front</md-icon><div>Resize</div></md-button><md-button style="line-height: 1.2;font-weight: bold;" ng-click="cancel()"><md-icon aria-label="Close dialog">done</md-icon><div>Done</div></md-button></div></md-toolbar><md-dialog-content><div class="tp-detail dialog">' +
                    htmltemplate +
