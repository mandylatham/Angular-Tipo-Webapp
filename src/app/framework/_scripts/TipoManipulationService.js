    ...
    function TipoManipulationService(tipoRegistry, $rootScope, $q, $mdMedia, $filter, $stateParams) {
        ...
        function getVirtualRepeatObject(per_page, tipo_name, getTipos, searchCriteria, default_tipos, count) {
            ...
            var infiniteItems = {
                ...
                fetchMoreItems_: function(index, page, state) {
                    ...
                    if (!this.busy && (this.page < this.maxpages || page <= this.maxpages)) {
                        ...
                        if (this.last_evaluated_key && state !== 'refresh') {
                            this.filter.last_evaluated_key = this.last_evaluated_key;
        ...
        function getItemsfromTipodefintion(field_names, fq_field_name, scope, keyword) {
            ...
            return getKeysFromTipodefinition(scope.context);
        }
        ...
        this.initGA = initGA;
        this.getItemsfromTipodefintion = getItemsfromTipodefintion;
        this.getItemsFromObject = getItemsFromObject;
    }
